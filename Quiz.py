...
question = {
    "Which of the following is not a programming language?": ['Java', 'C++', 'HTML', 'C#'],
    "Which of the following is not a conditional statement in python?": ['If', 'If else', 'elif', 'do while'],
    "What is a correct syntax to output Hello World in Python?": ['P(Hello world)', 'print("Hello world")', '(Hello world)', 'echo("Hello World)']
}
# define answer list
ans = ['HTML', 'do while', 'print("Hello world")']
